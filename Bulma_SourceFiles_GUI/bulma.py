...
def write_orca_inp(
    ...
    *,
    ...
    kws.append(theory)
    if dispersion:
        kws.append(dispersion)
    kws += [basis, "VeryTightSCF"]
...
def main() -> int:
    ...
    ap.add_argument("--gau-dispersion", default=None, help="Gaussian EmpiricalDispersion value to include (for example: GD3BJ)")
    ap.add_argument("--orca-dispersion", default=None, help="ORCA dispersion keyword to include (for example: D4)")
    ap.add_argument("--qchem-dft-d", default=None, help="Q-Chem DFT_D value to include (for example: D4)")
    ap.add_argument(
            "--extract-geo",
            action="store_true",
    ...
    if args.opt or args.freq or args.dyn or args.orca_opt or args.orca_freq or args.orca_qmd or args.qchem_opt or args.qchem_opt_freq or args.qchem_opt_single or args.qchem_freq or args.qchem_qmd:
        ...
        if args.orca_qmd:
            ...
            write_orca_qmd_inp(
                    ...
                    dispersion=args.orca_dispersion,
                    )
        ...
        if args.opt:
            ...
            write_gaussian_com(
                ...
                charge=args.charge,
                mult=args.mult,
                dispersion=args.gau_dispersion,
            )
