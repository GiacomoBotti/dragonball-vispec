...
def build_argparser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(
        description="time-averaged (TA) FT / spectra",
    ...
    ap.add_argument(
        ...
        nargs="+",
        default=None,
        help="Mode indices to process (1-based vibrational indices). Supports ranges: 1-5, 10..12, 20:22 and commas. Required with nm option (default)",
    )
...
def main() -> None:
    ...
    modes = parse_index_ranges(" ".join(args.modes)) if args.modes else []
